...
public class FrostShockwaveModel extends EntityModel<FrostShockwaveRenderState> {
    protected FrostShockwaveModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(@NotNull FrostShockwaveRenderState frostShockwaveRenderState) {
        super.setupAnim(frostShockwaveRenderState);
    }
}
