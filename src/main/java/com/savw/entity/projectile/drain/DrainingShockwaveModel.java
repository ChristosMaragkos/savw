...
public class DrainingShockwaveModel extends EntityModel<DrainingShockwaveRenderState> {
    protected DrainingShockwaveModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(@NotNull DrainingShockwaveRenderState drainingShockwaveRenderState) {
