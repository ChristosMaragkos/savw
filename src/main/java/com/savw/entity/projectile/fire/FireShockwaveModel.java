...
public class FireShockwaveModel extends EntityModel<FireShockwaveRenderState> {
    protected FireShockwaveModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(@NotNull FireShockwaveRenderState forceShockwaveRenderState) {
