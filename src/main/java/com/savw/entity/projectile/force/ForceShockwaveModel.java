...
public class ForceShockwaveModel extends EntityModel<ForceShockwaveRenderState> {
    protected ForceShockwaveModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(@NotNull ForceShockwaveRenderState forceShockwaveRenderState) {
        super.setupAnim(forceShockwaveRenderState);
    }
}
