...
public final class BecomeEtherealShout extends AbstractShout{
    ...
    private BecomeEtherealShout(String name, String description, ShoutWord firstWord, ShoutWord secondWord, ShoutWord thirdWord, ResourceLocation iconLocation, ResourceKey<Level> dimension) {
