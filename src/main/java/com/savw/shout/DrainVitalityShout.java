...
public final class DrainVitalityShout extends AbstractShout {
    ...
    private DrainVitalityShout(String name, String description, ShoutWord firstWord, ShoutWord secondWord, ShoutWord thirdWord, ResourceLocation iconLocation, ResourceKey<Level> dimension) {
